...
Usage:
    uv run python query.py "How should I handle auth redirects?" --vault ~/Documents/Vaults/work
    uv run python query.py "What patterns do I use for API design?" --vault ~/Documents/Vaults/work --file-back
"""
...
2. Use the Q&A article format (frontmatter with title, question,
